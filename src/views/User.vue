  ...
  <div class="album py-5 bg-light">
    <div class="container">
      ...
      <UserProfileCard
        ...
        @after-switch-following="afterSwitchFollowing"
      />
...
export default {
  ...
  methods: {
    fetchUserData() {
      ...
      this.name = dummyData.profile.name;
      this.email = dummyData.profile.email;
      this.userImage = dummyData.profile.image;
      this.isFollowed = dummyData.isFollowed;
      this.comments = dummyData.profile.Comments;
      this.commentsCount = dummyData.profile.Comments.length;
